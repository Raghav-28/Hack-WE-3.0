...
import WomenSafety from "../assets/ThemeLogo/women_safety-removebg-preview.png";
...
const HackathonThemes = () => {
  ...
  return (
    <section
      id="Theme"
      className="font-[Ghr4] bg-[#247448] text-white py-16"
>
        ...
        <div className="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 gap-8 items-cente justify-center">
          {themes.map((theme, index) => (
            <div
              ...
              className="theme-card h-56 bg-[#1db292] rounded-lg p-6 flex flex-col items-center shadow-lg transition-transform transform hover:scale-105"
            >
              <img
                src={theme.image}
                alt={theme.title}
